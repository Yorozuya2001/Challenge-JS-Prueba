...
console.log(axel);
axel.addFriend("Nicolas", 24);
console.log(axel);
axel.addHobby("Jugar WarZone");
console.log(axel);
console.log(axel.getFriends());
console.log(axel.getHobbies());
console.log(axel.getPromedioEdad());
